...
export default function Transactions() {
  ...
  const handleEdit = (record) => {
    navigate(`/transactions/${record._id}`);
  };
  const handleAdd = () => {
  ...
  const handleDelete = async (record) => {
    try {
      const res = await fetch(
        `http://localhost:5000/api-warehouse/transaction/${record._id}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
  ...
  const columns = [
    Object.assign(
      ...
      getColumnSearchProps("approval_name")
    ),
    Object.assign(
      {
        title: "Product Name",
    ...
    Object.assign(
      ...
      getColumnSearchProps("good_stock")
    ),
    Object.assign(
      {
        title: "Description",
